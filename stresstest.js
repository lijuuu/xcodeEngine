...
export default function () {
  ...
  let goRes = http.post('https://xengine.lijuu.me/execute', JSON.stringify({
    language: "go",
  ...
  // Test for C++ code
  startTime = new Date();
  let cppRes = http.post('https://xengine.lijuu.me/execute', JSON.stringify({
    language: "cpp",
  ...
  startTime = new Date();
  let pythonRes = http.post('https://xengine.lijuu.me/execute', JSON.stringify({
    language: "python",
  ...
  startTime = new Date();
  let nodeRes = http.post('https://xengine.lijuu.me/execute', JSON.stringify({
    language: "js",
